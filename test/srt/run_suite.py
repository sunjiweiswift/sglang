...
suites = {
    ...
    "per-commit-xpu-intel": [
        TestFile("test_abort.py", 50),
        TestFile("test_awq.py", 800),
        TestFile("test_create_kvindices.py", 20),
        TestFile("test_custom_allreduce.py", 20),
        TestFile("test_embedding_openai_server.py", 60),
        TestFile("test_fa3.py", 20),
        TestFile("test_fim_completion.py", 50),
        TestFile("test_input_embeddings.py", 60),
        TestFile("test_io_struct.py", 20),
        TestFile("test_large_max_new_tokens.py", 200),
        TestFile("test_local_attn.py", 20),
        TestFile("test_matched_stop.py", 50),
        TestFile("test_metrics.py", 50),
        TestFile("test_models_from_modelscope.py", 50),
        TestFile("test_no_chunked_prefill.py", 600),
        TestFile("test_no_overlap_scheduler.py", 900),
        ...
        TestFile("test_request_length_validation.py", 50),
        TestFile("test_retract_decode.py", 500),
        TestFile("test_sagemaker_server.py", 50),
        TestFile("test_schedule_policy.py", 20),
        TestFile("test_server_args.py", 20),
        TestFile("test_skip_tokenizer_init.py", 200),
        ...
        TestFile("test_vertex_endpoint.py", 50),
    ],
    "nightly": [
